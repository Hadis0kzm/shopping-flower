...
const cards = () => {
    ...
    return (
        <div className={styles.MainContainer}>
          ...
          <Card id="4" image={p4} name="avbiusdnfdfnvdfvndf pot" price="25" info="jgnrg gnergn grtnert JDFNDJKF DKJGJDFKNVD"/>
          ...
          <Card id="7" image={p7} name="avbiusdfvndf " price="5" info="jgnrg gnergn grtnert JDFNDJKhfhfghgffhgfhfghfgmbhfkgb mfkgbmtgkbmgfvbnjifokvmbjkgfgbhjbkgmbhkgg  fkgkbm rkgjf kgtfbh F DKJGJDFKNVD"/>  
          ...
          <Card id="10" image={p10} name="avbiusdnfdfnfvvvvvvvvvvvvdfvndf pot" price="6" info="jgnrg gnergn grtnert JDFNDJKF DKJGJDFKNVD"/>
